  ...
  String getCurrentRoute(BottomBarEnum type) {
    switch (type) {
      ...
      case BottomBarEnum.Chat:
        return AppRoutes.chatScreen; //ADDED THE 3 ADDITIONAL ROUTES
  ...
  Widget getCurrentPage(BuildContext context, String currentRoute) {
    switch (currentRoute) {
      ...
      case AppRoutes.chatScreen:
        return ChatScreen.builder(
            context); //ADDED THE 3 ADDITIONAL BUILDER CONTEXTS
      case AppRoutes.eventsScreen:
        return EventsScreen.builder(context);
